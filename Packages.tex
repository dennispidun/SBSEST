...
% Ermöglichen mathematischer Symbole
\usepackage{amsmath,amsfonts}

% Für die Definition der Zeilenabstände, Seitenränder etc.
\usepackage{setspace}
\usepackage{geometry}
...
\usepackage[
    ...
    colorlinks=true, % Farbe von Verknüpfungen
    ...
    pdfusetitle % Ermöglicht das Setzen der Meta-Daten des erzeugten PDFs
]{hyperref}
...
% Wird für Teile der Formatierung des Deckblatts und die Verwendung von
% Aufzählungen benötigt
\usepackage{listings}
\usepackage{xcolor} 
...
% Für das Erstellen eines Glossars
